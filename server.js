...
const sendEmail = require('./mailer'); // Assumes you have mailer.js set up correctly
const app = express();
...
// POST: Room Booking (Updated)
app.post('/api/book-room', async (req, res) => {
  try {
    console.log("📦 Received booking request:", req.body);

    const { name, email, phone, roomType, checkIn, checkOut, specialRequests } = req.body;
...
// POST: Contact Form (uses sendEmail)
